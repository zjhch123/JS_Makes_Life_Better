...
draw()
document.querySelector('.J_start').addEventListener('click', (event) => {
  event.target.classList.remove('J_start')
  const musicContext = createAudioContext()
